...
# Estades Delta build configuration file
...
project = "Estades Delta"
author = "Josep Castells"
trademark_name = "estadesdelta"
now = datetime.now()
year = str(now.year)
copyright = year
...
linkcheck_ignore = [
    ...
    r"https://github.com/estadesdelta/estadesdelta/issues/new",  # requires auth
...
html_theme_options = {
    ...
    "icon_links": [
        {
            "name": "GitHub",
            "url": "https://github.com/estadesdelta/estadesdelta",
    ...
    "repository_url": "https://github.com/estadesdelta/estadesdelta",
...
# html_context = {
#     "edit_page_url_template": "https://github.com/estadesdelta/estadesdelta/edit/main/docs/",
# }
...
ogp_site_name = "Estades Delta Documentation"
ogp_type = "website"
...
htmlhelp_basename = "Estades DeltaDocumentation"
...
latex_documents = [
    (
        "index",
        "Estades DeltaDocumentation.tex",
        "Estades Delta Documentation",
        "estadesdelta community",
        "manual",
    ),
]
